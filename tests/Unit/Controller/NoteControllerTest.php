<?php
namespace OCA\WelcomApp\Tests\Unit\Controller;
...
class NoteControllerTest extends PHPUnit_Framework_TestCase{
    ...
    public function setUp() {
        ...
        $this->service = $this->getMockbuilder('OCP\WelcomApp\Service\NoteService')
            ->disableOriginalConstructor()
            ->getMock();
        $this->controller = new NoteController(
            'welcomapp',$this->request,$this->service,$this->userId
        );
    }
